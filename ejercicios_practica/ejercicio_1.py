...
def heading_analysis(heading, client):
    logging.debug(f"Heading {heading}")
    ...
    if estado_sistema == ESTADO_INICIO:
        if heading > THRESHOLD_INICIO:
            ...
            logging.debug(f"THRESHOLD_INICIO superado {heading}")
        ...
        if heading < THRESHOLD_INICIO:
            ...
            logging.debug(f"RESET ESTADO_INICIO {heading}")
            ...
            logging.debug(f"THRESHOLD_FIN superado {heading}")
